...
void EXTI2_IRQHandler(void)
{
    ...
    {
        if(GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_4) == 0)       /* If head in right position. Active "Low", passive "High"*/
        {
            if(GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_3) == 1)   /* Get rotary direction. PE2 Yellow, PE3 Grey, CW. */
            {
